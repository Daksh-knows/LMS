...
export default function QnaTab({ lectureId, courseId , adminId }: QnaTabProps) {
  ...
  // --- SINGLE QUESTION VIEW ---
      if (selectedQuestion) {
      // 1. Sort replies so teacher replies appear at the top
        ...
        <div className="py-6 space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
          ...
          <div className={`border rounded-xl p-6 shadow-sm ${isQuestionTeacher ? "bg-blue-50/30 border-blue-200" : "bg-white border-gray-200"}`}>
            <div className="flex justify-between items-start gap-4 mb-4">
              ...
              {/* Show delete only for owner or teacher (if applicable) */}
            ...
            <div className="mt-6 space-y-6">
              ...
              <form onSubmit={handleReplySubmit} className="mt-8 pt-4 border-t border-gray-50">
                <div className="flex items-start gap-3">
                  <div className="h-9 w-9 rounded-full bg-gray-900 flex-shrink-0 flex items-center justify-center text-white text-xs font-bold">
                  ...
                  <div className="relative flex-1">
                    ...
                    <button 
                      ...
                      type="submit"
                      className="absolute right-3 bottom-3 p-2 bg-gray-900 text-white rounded-xl hover:bg-black disabled:bg-gray-200 transition-all"
                    >
                      <Send size={18} />
                    </button>
                  </div>
