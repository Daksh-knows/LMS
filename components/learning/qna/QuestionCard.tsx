...
const QuestionCard = ({ 
  ...
  return (
    <div 
      onClick={onClick}
      className="group bg-[var(--qna-card-bg)] border border-[var(--qna-card-border)] rounded-xl p-5 flex gap-4 transition-all hover:brightness-105 cursor-pointer relative theme-transition shadow-sm"
    >
      {/* Avatar with Border */}
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        <h4 className="font-bold text-[var(--qna-text-primary)] text-base sm:text-lg leading-tight mb-1 truncate group-hover:text-[var(--colored-text)] transition-colors">
          {q.title}
        </h4>
        <p className="text-[var(--qna-text-primary)] opacity-60 text-xs sm:text-sm line-clamp-2 mb-4 leading-relaxed">
          {q.description}
        </p>
        
        {/* Card Footer Metadata */}
        <div className="flex items-center justify-between mt-auto">
          <div className="flex items-center gap-3 text-[var(--qna-text-primary)] text-xs font-bold">
          ...
          <div className="flex items-center gap-4 text-[var(--qna-text-primary)] opacity-70">
