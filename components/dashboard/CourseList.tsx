  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <div className="flex items-center justify-between px-1">
        <SplitText
          text={oneCourse ? "Featured Course" : "Featured Courses"}
          className="text-xl md:text-2xl font-bold text-(--text-color) theme-transition tracking-tight"
          delay={50}
          duration={1.25}
          ease="power3.out"
          splitType="chars"
      ...
      <div className={`
          relative overflow-hidden rounded-[9px] bg-(--streak-background) theme-transition
        ...
        <AnimatePresence mode="wait">
          <SpotlightCard className="bg-(--dashboard-card-bg) theme-transition" spotlightColor="rgba(250,189,35,0.4)">
              <motion.div
                key={course.id}
